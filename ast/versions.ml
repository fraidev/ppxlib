...
module OCaml_510 = struct
  module Ast = Astlib.Ast_510
  include Make_witness(Astlib.Ast_510)
  let version = 510
  let string_version = "5.0"
end
let ocaml_510 : OCaml_510.types ocaml_version = (module OCaml_510)
(*$*)
...
(module OCaml_510 : OCaml_version);
(*$*)
]
...
include Register_migration(OCaml_414)(OCaml_510)
    (Astlib.Migrate_414_510)(Astlib.Migrate_510_414)
(*$*)
